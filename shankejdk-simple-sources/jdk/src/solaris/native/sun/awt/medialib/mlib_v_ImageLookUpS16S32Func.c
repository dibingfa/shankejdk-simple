...
/***************************************************************/
static void mlib_v_ImageLookUp_S16_S32_124_D1(const mlib_s16 *src,
                                              mlib_f32       *dst,
                                              mlib_s32       xsize,
...
static void mlib_v_ImageLookUp_S16_S32_3_D1(const mlib_s16 *src,
                                            mlib_f32       *dst,
                                            mlib_s32       xsize,
                                            const mlib_f32 *table0,
                                            const mlib_f32 *table1,
...
/***************************************************************/
void mlib_v_ImageLookUp_S16_S32_124_D1(const mlib_s16 *src,
                                       mlib_f32       *dst,
                                       mlib_s32       xsize,
                                       const mlib_f32 *table0,
                                       const mlib_f32 *table1,
                                  ...
                                  const mlib_s32 **table)
{
  mlib_s16 *sl;
  mlib_s32 *dl;
  mlib_f32 *tab = (mlib_f32*)(&table[0][32768]);
  mlib_s32 j;
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_S32_124_D1(sp, dp, size, tab, tab, tab, tab);
    }
                                  ...
                                  const mlib_s32 **table)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    mlib_f32  *tab0 = (mlib_f32*)(&table[0][32768]);
    mlib_f32  *tab1 = (mlib_f32*)(&table[1][32768]);
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_S32_124_D1(sp, dp, size, tab0, tab1, tab0, tab1);
    }
                                  ...
                                  const mlib_s32 **table)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    mlib_f32  *tab0 = (mlib_f32*)(&table[0][32768]);
    mlib_f32  *tab1 = (mlib_f32*)(&table[1][32768]);
    mlib_f32  *tab2 = (mlib_f32*)(&table[2][32768]);
    mlib_f32  *tab3 = (mlib_f32*)(&table[3][32768]);
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_S32_124_D1(sp, dp, size, tab0, tab1, tab2, tab3);
    }
...
/***************************************************************/
void mlib_v_ImageLookUp_S16_S32_3_D1(const mlib_s16 *src,
                                     mlib_f32       *dst,
                                     mlib_s32       xsize,
                                     const mlib_f32 *table0,
                                     const mlib_f32 *table1,
                                  ...
                                  const mlib_s32 **table)
{
  ...
  for (j = 0; j < ysize; j ++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_S32_3_D1(sp, dp, size, tab0, tab1, tab2);
    }
