...
/***************************************************************/
static void mlib_v_ImageLookUp_S16_U8_124_D1(const mlib_s16 *src,
                                             mlib_u8        *dst,
                                             mlib_s32       xsize,
...
static void mlib_v_ImageLookUp_S16_U8_3_D1(const mlib_s16 *src,
                                           mlib_u8        *dst,
                                           mlib_s32       xsize,
                                           const mlib_u8  *table0,
                                           const mlib_u8  *table1,
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_U8_124_D1(sp, dp, size, tab, tab, tab, tab);
    }
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_U8_124_D1(sp, dp, size, tab0, tab1, tab0, tab1);
    }
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_U8_124_D1(sp, dp, size, tab0, tab1, tab2, tab3);
    }
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S16_U8_3_D1(sp, dp, size, tab0, tab1, tab2);
    }
