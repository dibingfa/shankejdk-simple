...
/***************************************************************/
static void mlib_v_ImageLookUp_S32_U8_124_D1(const mlib_s32 *src,
                                             mlib_u8        *dst,
                                             mlib_s32       xsize,
...
static void mlib_v_ImageLookUp_S32_U8_3_D1(const mlib_s32 *src,
                                           mlib_u8        *dst,
                                           mlib_s32       xsize,
                                           const mlib_u8  *table0,
                                           const mlib_u8  *table1,
...
/***************************************************************/
void mlib_v_ImageLookUp_S32_U8_124_D1(const mlib_s32 *src,
                                      mlib_u8        *dst,
                                      mlib_s32       xsize,
                                      const mlib_u8  *table0,
                                      const mlib_u8  *table1,
...
#pragma pipeloop(0)
  ...
  if ((mlib_addr) dp <= (mlib_addr) dend) {
    ...
    num = (mlib_s32) ((mlib_addr) dend - (mlib_addr) dp);
    sp += num;
    num++;
                                 ...
                                 const mlib_u8  **table)
{
  mlib_s32 *sl;
  mlib_u8 *dl;
  const mlib_u8 *tab = &table[0][(mlib_u32) 2147483648u];
  mlib_s32 j, i;
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S32_U8_124_D1(sp, dp, size, tab, tab, tab, tab);
    }
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S32_U8_124_D1(sp, dp, size, tab0, tab1, tab0, tab1);
    }
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S32_U8_124_D1(sp, dp, size, tab0, tab1, tab2, tab3);
    }
...
/***************************************************************/
void mlib_v_ImageLookUp_S32_U8_3_D1(const mlib_s32 *src,
                                    mlib_u8        *dst,
                                    mlib_s32       xsize,
                                    const mlib_u8  *table0,
                                    const mlib_u8  *table1,
                                 ...
                                 const mlib_u8  **table)
{
  ...
  for (j = 0; j < ysize; j++) {
    ...
    if (size > 0) {
      mlib_v_ImageLookUp_S32_U8_3_D1(sp, dp, size, tab0, tab1, tab2);
    }
